...
class BooksApp extends React.Component {
    ...
    moveToList = (book_id, book_shelf, event) => {
        ...
        if (book_shelf != "searchResults") {
            ...
            selectedBook = this.state.searchResultBooks.filter((book) => book.id == book.id)[0]
                        ...
                        searchResultBooks: this.state.searchResults.map((resultBook) => (
                                {
                                    ...
                                    author: resultBook.authors.length > 0 ? resultBook.authors.join(", ") : "",
                                    shelf: "searchResults",
            ...
            <div className="app">
                ...
                */}
                        ...
                        <div className="search-books-results">
                            <BookList books={this.state.searchResultBooks} onShelfChange={this.moveToList}
                                      shelf="searchResults"/>
                        </div>
                    </div>
                ) : (
